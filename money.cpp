...
void roundMoney(Money *money){
    money->cop = money->cop / 10 * 10 + (money->cop % 10 >= 4 ? 10 : 0);
}

void printMoney(Money *money){
    cout << "before round: " << money->grn << "grn " << money->cop << "cop\n"; 
}

void printMoney2(Money *money){
    cout << "after round: " << money->grn << "grn " << money->cop << "cop\n"; 
}
